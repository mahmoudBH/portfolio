  ...
  theme: {
    extend: {
      colors: {
        ...
        // Secondary Colors - Modern Accents
        secondary: {
          50: '#fdf4ff',
          100: '#fae8ff',
          200: '#f5d0fe',
        ...
        gradient: {
          ...
          dark: 'linear-gradient(135deg, #0c4a6e 0%, #1e1b4b 100%)',
        }
      },
      fontFamily: {
      ...
      backgroundImage: {
        ...
        'noise-texture': "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' opacity='0.1'/%3E%3C/svg%3E\")",
      },
      boxShadow: {
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
        'neumorphic': '20px 20px 60px #0a0a0a, -20px -20px 60px #1a1a1a',
        'depth': '0 10px 30px -15px rgba(0, 0, 0, 0.3)',
      }
    },
  },
